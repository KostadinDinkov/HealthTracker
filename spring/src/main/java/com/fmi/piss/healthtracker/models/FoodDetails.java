...
public class FoodDetails {
    ...
    @JsonProperty("serving_qty")
    public void setServingQty(long value) {
    ...
    @JsonProperty("serving_weight_grams")
    public void setServingWeightGrams(double value) {
        this.servingWeightGrams = value;
    }
    ...
    @JsonProperty("nf_total_fat")
    public void setNfTotalFat(double value) {
        this.nfTotalFat = value;
    }
    ...
    @JsonProperty("nf_saturated_fat")
    public void setNfSaturatedFat(double value) {
        this.nfSaturatedFat = value;
    }
    ...
    @JsonProperty("nf_cholesterol")
    public void setNfCholesterol(double value) {
        this.nfCholesterol = value;
    }
    ...
    @JsonProperty("nf_sodium")
    public void setNfSodium(double value) {
        this.nfSodium = value;
    }
    ...
    @JsonProperty("nf_total_carbohydrate")
    public void setNfTotalCarbohydrate(double value) {
        this.nfTotalCarbohydrate = value;
    }

    @JsonProperty("nf_dietary_fiber")
    public long getNfDietaryFiber() {
        return nfDietaryFiber;
    }

    @JsonProperty("nf_dietary_fiber")
    public void setNfDietaryFiber(long value) {
        this.nfDietaryFiber = value;
    }
    ...
    @JsonProperty("nf_sugars")
    public void setNfSugars(double value) {
        this.nfSugars = value;
    }
    ...
    @JsonProperty("nf_protein")
    public void setNfProtein(double value) {
        this.nfProtein = value;
    }
    ...
    @JsonProperty("nf_potassium")
    public void setNfPotassium(double value) {
        this.nfPotassium = value;
    }
    ...
    @JsonProperty("nf_p")
    public void setNfP(double value) {
        this.nfP = value;
    }
    ...
    @JsonProperty("nix_brand_name")
    public void setNixBrandName(String value) {
        this.nixBrandName = value;
    }
    ...
    @JsonProperty("nix_brand_id")
    public void setNixBrandID(String value) {
        this.nixBrandID = value;
    }
    ...
    @JsonProperty("nix_item_name")
    public void setNixItemName(String value) {
        this.nixItemName = value;
    }
    ...
    @JsonProperty("nix_item_id")
    public void setNixItemID(String value) {
        this.nixItemID = value;
    }
    ...
    @JsonProperty("ndb_no")
    public void setNdbNo(long value) {
        this.ndbNo = value;
    }
    ...
    @JsonProperty("meal_type")
    public void setMealType(long value) {
        this.mealType = value;
    }
