...
public class Exercise {
  ...
  //  private User user;
    ...
    @JsonProperty("user_input")
    public void setUserInput(String value) { this.userInput = value; }

    @JsonProperty("duration_min")
    public double getDurationMin() { return durationMin; }
    @JsonProperty("duration_min")
    public void setDurationMin(double value) { this.durationMin = value; }

    @JsonProperty("met")
    public long getMet() { return met; }
    @JsonProperty("met")
    public void setMet(long value) { this.met = value; }
    ...
    public long getCompendiumCode() { return compendiumCode; }
    @JsonProperty("compendium_code")
    public void setCompendiumCode(long value) { this.compendiumCode = value; }
